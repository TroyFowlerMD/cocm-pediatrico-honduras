...
const REG_DEFAULT_APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxeYSvVau-oXTM0itCnKMjmGS8nk6dBbGs4fB71tHlVQEBZFtX9FVPGR5rRHjnIM_Qe/exec'; // v2.2 — Version 9 — active deployment (confirmed 2026-05-05)
...
const REG_CACHE_KEY = REG_LS.CACHE + '.v4'; // bumped: force re-fetch after Aurora manual insert + V9 deploy
function readCache() {
  try {
...
// ── Shared medication constants (used by both registry and patient pages) ──
const MED_FORMULARY = [
  'Gabapentin 300 mg',
  'Fluoxetine 20 mg',
  'Hydroxyzine 25 mg',
...
if (typeof window !== 'undefined') window.MED_FORMULARY = MED_FORMULARY;
if (typeof window !== 'undefined') window.MED_FREQ_PRESETS = MED_FREQ_PRESETS;
